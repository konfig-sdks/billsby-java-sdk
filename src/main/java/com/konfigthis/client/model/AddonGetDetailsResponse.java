...
import com.konfigthis.client.model.AddonGetDetailsResponsePlansInner;
import com.konfigthis.client.model.AddonGetDetailsResponsePriceModelsInner;
...
public class AddonGetDetailsResponse {
  ...
  private List<AddonGetDetailsResponsePlansInner> plans = null;

  public static final String SERIALIZED_NAME_PRICE_MODELS = "priceModels";
  @SerializedName(SERIALIZED_NAME_PRICE_MODELS)
  private List<AddonGetDetailsResponsePriceModelsInner> priceModels = null;

  public AddonGetDetailsResponse() {
  }

  public AddonGetDetailsResponse description(String description) {
  ...
  **/
  ...
  public AddonGetDetailsResponse addonId(Integer addonId) {
  ...
  **/
  ...
  public AddonGetDetailsResponse name(String name) {
  ...
  **/
  ...
  public AddonGetDetailsResponse displayName(String displayName) {
  ...
  **/
  ...
  public AddonGetDetailsResponse singleUnitName(String singleUnitName) {
  ...
  **/
  ...
  public AddonGetDetailsResponse pluralUnitName(String pluralUnitName) {
  ...
  **/
  ...
  public AddonGetDetailsResponse pricingModelType(String pricingModelType) {
  ...
  **/
  ...
  public AddonGetDetailsResponse hasActiveLinkedPlans(Boolean hasActiveLinkedPlans) {
  ...
  **/
  ...
  public AddonGetDetailsResponse featureTags(List<String> featureTags) {
  ...
  public AddonGetDetailsResponse addFeatureTagsItem(String featureTagsItem) {
  ...
  **/
  ...
  public AddonGetDetailsResponse plans(List<AddonGetDetailsResponsePlansInner> plans) {
  ...
  public AddonGetDetailsResponse addPlansItem(AddonGetDetailsResponsePlansInner plansItem) {
    if (this.plans == null) {
  ...
  **/
  ...
  public List<AddonGetDetailsResponsePlansInner> getPlans() {
    return plans;
  }


  public void setPlans(List<AddonGetDetailsResponsePlansInner> plans) {
  ...
  public AddonGetDetailsResponse priceModels(List<AddonGetDetailsResponsePriceModelsInner> priceModels) {
  ...
  public AddonGetDetailsResponse addPriceModelsItem(AddonGetDetailsResponsePriceModelsInner priceModelsItem) {
  ...
  **/
  ...
  public List<AddonGetDetailsResponsePriceModelsInner> getPriceModels() {
    return priceModels;
  }


  public void setPriceModels(List<AddonGetDetailsResponsePriceModelsInner> priceModels) {
   ...
   * @return the AddonGetDetailsResponse instance itself
   */
  public AddonGetDetailsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddonGetDetailsResponse addonGetDetailsResponse = (AddonGetDetailsResponse) o;
    return Objects.equals(this.description, addonGetDetailsResponse.description) &&
        Objects.equals(this.addonId, addonGetDetailsResponse.addonId) &&
        Objects.equals(this.name, addonGetDetailsResponse.name) &&
        Objects.equals(this.displayName, addonGetDetailsResponse.displayName) &&
        Objects.equals(this.singleUnitName, addonGetDetailsResponse.singleUnitName) &&
        Objects.equals(this.pluralUnitName, addonGetDetailsResponse.pluralUnitName) &&
        Objects.equals(this.pricingModelType, addonGetDetailsResponse.pricingModelType) &&
        Objects.equals(this.hasActiveLinkedPlans, addonGetDetailsResponse.hasActiveLinkedPlans) &&
        Objects.equals(this.featureTags, addonGetDetailsResponse.featureTags) &&
        Objects.equals(this.plans, addonGetDetailsResponse.plans) &&
        Objects.equals(this.priceModels, addonGetDetailsResponse.priceModels)&&
        Objects.equals(this.additionalProperties, addonGetDetailsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, addonId, name, displayName, singleUnitName, pluralUnitName, pricingModelType, hasActiveLinkedPlans, featureTags, plans, priceModels, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddonGetDetailsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddonGetDetailsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddonGetDetailsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddonGetDetailsResponse is not found in the empty JSON string", AddonGetDetailsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("plans") != null && !jsonObj.get("plans").isJsonNull()) {
        ...
        if (jsonArrayplans != null) {
          ...
          for (int i = 0; i < jsonArrayplans.size(); i++) {
            AddonGetDetailsResponsePlansInner.validateJsonObject(jsonArrayplans.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("priceModels") != null && !jsonObj.get("priceModels").isJsonNull()) {
        ...
        if (jsonArraypriceModels != null) {
          ...
          for (int i = 0; i < jsonArraypriceModels.size(); i++) {
            AddonGetDetailsResponsePriceModelsInner.validateJsonObject(jsonArraypriceModels.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddonGetDetailsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddonGetDetailsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddonGetDetailsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddonGetDetailsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AddonGetDetailsResponse>() {
           @Override
           public void write(JsonWriter out, AddonGetDetailsResponse value) throws IOException {
           ...
           @Override
           public AddonGetDetailsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddonGetDetailsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddonGetDetailsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddonGetDetailsResponse
  * @throws IOException if the JSON string is invalid with respect to AddonGetDetailsResponse
  */
  public static AddonGetDetailsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddonGetDetailsResponse.class);
  }

 /**
  * Convert an instance of AddonGetDetailsResponse to an JSON string
  *
  * @return JSON string
  */
