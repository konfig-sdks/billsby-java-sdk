...
public class ProductCreatePlanResponseCyclesInnerPricingModel {
  ...
  public ProductCreatePlanResponseCyclesInnerPricingModel() {
  }

  public ProductCreatePlanResponseCyclesInnerPricingModel pricingModelId(Integer pricingModelId) {
  ...
  **/
  ...
  public ProductCreatePlanResponseCyclesInnerPricingModel frequency(Integer frequency) {
  ...
  **/
  ...
  public ProductCreatePlanResponseCyclesInnerPricingModel frequencyType(Integer frequencyType) {
  ...
  **/
  ...
  public ProductCreatePlanResponseCyclesInnerPricingModel freeTrial(Integer freeTrial) {
  ...
  **/
  ...
  public ProductCreatePlanResponseCyclesInnerPricingModel freeTrialFrequencyType(Integer freeTrialFrequencyType) {
  ...
  **/
  ...
  public ProductCreatePlanResponseCyclesInnerPricingModel contractTerm(Integer contractTerm) {
  ...
  **/
  ...
  public ProductCreatePlanResponseCyclesInnerPricingModel contractTermFrequencyType(Integer contractTermFrequencyType) {
  ...
  **/
  ...
  public ProductCreatePlanResponseCyclesInnerPricingModel setupFeePrice(Integer setupFeePrice) {
  ...
  **/
  ...
  public ProductCreatePlanResponseCyclesInnerPricingModel setupFeePriceFormatted(String setupFeePriceFormatted) {
  ...
  **/
  ...
  public ProductCreatePlanResponseCyclesInnerPricingModel freeQuantity(Integer freeQuantity) {
  ...
  **/
  ...
  public ProductCreatePlanResponseCyclesInnerPricingModel billingDateType(Integer billingDateType) {
  ...
  **/
  ...
  public ProductCreatePlanResponseCyclesInnerPricingModel fixedBillingDateDay(Integer fixedBillingDateDay) {
  ...
  **/
  ...
  public ProductCreatePlanResponseCyclesInnerPricingModel proRateOption(Integer proRateOption) {
  ...
  **/
   ...
   * @return the ProductCreatePlanResponseCyclesInnerPricingModel instance itself
   */
  public ProductCreatePlanResponseCyclesInnerPricingModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProductCreatePlanResponseCyclesInnerPricingModel productCreatePlanResponseCyclesInnerPricingModel = (ProductCreatePlanResponseCyclesInnerPricingModel) o;
    return Objects.equals(this.pricingModelId, productCreatePlanResponseCyclesInnerPricingModel.pricingModelId) &&
        Objects.equals(this.frequency, productCreatePlanResponseCyclesInnerPricingModel.frequency) &&
        Objects.equals(this.frequencyType, productCreatePlanResponseCyclesInnerPricingModel.frequencyType) &&
        Objects.equals(this.freeTrial, productCreatePlanResponseCyclesInnerPricingModel.freeTrial) &&
        Objects.equals(this.freeTrialFrequencyType, productCreatePlanResponseCyclesInnerPricingModel.freeTrialFrequencyType) &&
        Objects.equals(this.contractTerm, productCreatePlanResponseCyclesInnerPricingModel.contractTerm) &&
        Objects.equals(this.contractTermFrequencyType, productCreatePlanResponseCyclesInnerPricingModel.contractTermFrequencyType) &&
        Objects.equals(this.setupFeePrice, productCreatePlanResponseCyclesInnerPricingModel.setupFeePrice) &&
        Objects.equals(this.setupFeePriceFormatted, productCreatePlanResponseCyclesInnerPricingModel.setupFeePriceFormatted) &&
        Objects.equals(this.freeQuantity, productCreatePlanResponseCyclesInnerPricingModel.freeQuantity) &&
        Objects.equals(this.billingDateType, productCreatePlanResponseCyclesInnerPricingModel.billingDateType) &&
        Objects.equals(this.fixedBillingDateDay, productCreatePlanResponseCyclesInnerPricingModel.fixedBillingDateDay) &&
        Objects.equals(this.proRateOption, productCreatePlanResponseCyclesInnerPricingModel.proRateOption)&&
        Objects.equals(this.additionalProperties, productCreatePlanResponseCyclesInnerPricingModel.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductCreatePlanResponseCyclesInnerPricingModel {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductCreatePlanResponseCyclesInnerPricingModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductCreatePlanResponseCyclesInnerPricingModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductCreatePlanResponseCyclesInnerPricingModel is not found in the empty JSON string", ProductCreatePlanResponseCyclesInnerPricingModel.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductCreatePlanResponseCyclesInnerPricingModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductCreatePlanResponseCyclesInnerPricingModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductCreatePlanResponseCyclesInnerPricingModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductCreatePlanResponseCyclesInnerPricingModel.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductCreatePlanResponseCyclesInnerPricingModel>() {
           @Override
           public void write(JsonWriter out, ProductCreatePlanResponseCyclesInnerPricingModel value) throws IOException {
           ...
           @Override
           public ProductCreatePlanResponseCyclesInnerPricingModel read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductCreatePlanResponseCyclesInnerPricingModel instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductCreatePlanResponseCyclesInnerPricingModel given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductCreatePlanResponseCyclesInnerPricingModel
  * @throws IOException if the JSON string is invalid with respect to ProductCreatePlanResponseCyclesInnerPricingModel
  */
  public static ProductCreatePlanResponseCyclesInnerPricingModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductCreatePlanResponseCyclesInnerPricingModel.class);
  }

 /**
  * Convert an instance of ProductCreatePlanResponseCyclesInnerPricingModel to an JSON string
  *
  * @return JSON string
  */
