...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://public.billsby.com/api/v1/rest/core";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("sec0", new ApiKeyAuth("header", "ApiKey"));
    ...
    private void init() {
        ...
        setUserAgent("Konfig/1.3.5/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://public.billsby.com/api/v1/rest/core)
